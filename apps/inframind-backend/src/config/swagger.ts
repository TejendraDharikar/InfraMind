...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'AI-Powered DevOps Dashboard — REST API for infrastructure monitoring, metrics collection, and intelligent alerting.',
      contact: {
        name: 'Inframind Team',
      },
      license: {
      ...
      schemas: {
        ...
        Metric: {
          ...
          properties: {
            ...
            networkUsage: {
              type: 'number',
              description: 'Network usage percentage (0-100)',
            },
            diskUsage: {
              type: 'number',
        ...
        Alert: {
          ...
          properties: {
            ...
            type: {
              type: 'string',
              description: 'Alert type (cpu, memory, network, disk, anomaly)',
            },
